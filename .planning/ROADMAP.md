...
- [x] 09-03-PLAN.md -- EntityPicker sidebar (tabbed zone browser with search), EntityPickerTab, SceneDetailEditor restructure (horizontal split with preview and picker integration)
**UI hint**: yes
