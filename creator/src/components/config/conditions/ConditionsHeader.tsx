      ...
      <div className="flex flex-wrap items-center gap-4">
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-0.5 text-2xs leading-relaxed text-text-muted">
            Tune ticking behavior, stack rules, and stat pressure for every
            condition in one editing pass.
          </p>
        </div>

        <div className="flex flex-wrap items-center gap-2">
          <StatPill count={effectTypeCount} label="Effect Types" />
          <StatPill count={stackBehaviorCount} label="Stack Behaviors" />
        </div>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            title="Duplicate the selected condition"
