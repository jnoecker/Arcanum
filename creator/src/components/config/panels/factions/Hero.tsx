 ...
 * lede sit directly on the panel bg, with the three reputation knobs as
 * a row of stat tiles. No wrapping panel surface; lets the island art
 * read through and matches the World panel's air-first composition.
 */
