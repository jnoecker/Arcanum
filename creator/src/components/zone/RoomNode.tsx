...
/** Role pill badges (bank, tavern/lottery, dungeon, auction, stylist, housingBroker) */
function RoleBadges({ d }: { d: RoomNodeData }) {
  if (!d.bank && !d.tavern && !d.dungeon && !d.auction && !d.stylist && !d.housingBroker) return null;
  return (
