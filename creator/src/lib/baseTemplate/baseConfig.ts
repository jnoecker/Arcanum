...
export const BASE_PETS: Record<string, PetDefinitionConfig> = {
  wolf_companion: {
    ...
    spells: {
      savage_bite: {
        ...
        message: "The wolf lunges forward and sinks its fangs into you",
        roomMessage: "{mob} lunges at {target} with bared fangs.",
        minDamage: 3,
        maxDamage: 6,
        cooldownMs: 6000,
        weight: 3,
      ...
      howl: {
        displayName: "Howl",
        message: "The wolf throws back its head and howls, rallying its master",
        roomMessage: "{mob} throws back its head and howls.",
        healMin: 2,
        healMax: 4,
        cooldownMs: 15000,
        weight: 1,
  ...
  spirit_hawk: {
    ...
    spells: {
      talon_strike: {
        ...
        message: "The spirit hawk dives from above and rakes you with spectral talons",
        roomMessage: "{mob} dives at {target} with glowing talons.",
        minDamage: 5,
        maxDamage: 9,
        cooldownMs: 5000,
        weight: 3,
      ...
      screech: {
        displayName: "Screech",
        message: "The spirit hawk lets out a piercing screech that disorients you",
        roomMessage: "{mob} lets out a piercing screech.",
        minDamage: 2,
        maxDamage: 4,
        cooldownMs: 10000,
        weight: 1,
  ...
  bear_guardian: {
    ...
    spells: {
      maul: {
        displayName: "Maul",
        message: "The bear rears up and slams its massive paws down on you",
        roomMessage: "{mob} rears up and mauls {target}.",
        minDamage: 7,
        maxDamage: 12,
        cooldownMs: 8000,
        weight: 3,
      ...
      roar: {
        displayName: "Roar",
        message: "The bear lets out a thunderous roar, its wounds closing as vitality surges through it",
        roomMessage: "{mob} roars and its wounds begin to close.",
        healMin: 4,
        healMax: 8,
        cooldownMs: 15000,
        weight: 1,
