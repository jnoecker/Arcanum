...
const SECTION_ORDER: { template: ArticleTemplate | "timeline"; label: string }[] = [
  ...
  { template: "ancestry", label: "Peoples & Ancestries" },
  { template: "bestiary", label: "Bestiary" },
  { template: "species", label: "Peoples & Species (legacy)" },
  ...
  { template: "profession", label: "Professions (legacy)" },
  { template: "talent", label: "Talents" },
  { template: "creature_power", label: "Creature Powers" },
  { template: "ability", label: "Abilities (legacy)" },
