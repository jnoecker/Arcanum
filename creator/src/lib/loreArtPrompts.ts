...
const FORMAT: Record<ArticleTemplate, string> = {
  ...
  talent: "1:1 square spell or skill icon, magical energy effect, centered glow",
  creature_power: "1:1 square mythic-power icon, swirling primal or otherworldly energy, centered glow",
