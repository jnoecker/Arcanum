...
const CHARACTER_PANELS: PanelDef[] = [
  ...
  { id: "characterSprites", label: "Sprite Config", group: "characters", host: "config", kicker: "Sprite config", title: "Sprite rules", description: "Image serving and asset base URL.", maxWidth: "max-w-5xl", subGroup: "Identity", island: "spire", glyph: "\u{1F9EC}" },
