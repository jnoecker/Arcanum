...
const CHARACTER_PANELS: PanelDef[] = [
  ...
  { id: "characterSprites", label: "Sprite Config", group: "characters", host: "config", kicker: "Sprite config", title: "Sprite rules", description: "Image serving, sprite tiers, and player tier visuals.", maxWidth: "max-w-5xl", subGroup: "Identity", island: "spire", glyph: "\u{1F9EC}" },
...
const SYSTEMS_PANELS: PanelDef[] = [
  ...
  { id: "achievements", label: "Achievements", group: "systems", host: "config", kicker: "Content", title: "Achievements", description: "Achievement categories and criteria types.", maxWidth: "max-w-5xl", subGroup: "Content", island: "orrery", glyph: "\u{1F3C6}" },
  { id: "achievementDefs", label: "Achievement Builder", group: "systems", host: "config", kicker: "Content", title: "Achievement builder", description: "Define achievements, criteria, and rewards.", maxWidth: "max-w-5xl", subGroup: "Content", island: "livingWorld", glyph: "\u{1F3C6}" },
...
const LORE_PANELS: PanelDef[] = [
  ...
  { id: "showcaseSettings", label: "Showcase", group: "lore", host: "lore", kicker: "Publication", title: "Showcase settings", description: "Branding and appearance for the published showcase site.", maxWidth: "max-w-5xl", island: "settings", glyph: "\u{1F310}" },
...
const OPERATIONS_PANELS: PanelDef[] = [
  ...
  { id: "services", label: "Services", group: "operations", host: "config", kicker: "Operations", title: "Services", description: "API keys, image providers, and LLM settings.", maxWidth: "max-w-5xl", island: "settings", glyph: "\u{1F511}" },
  ...
  { id: "sharedAssets", label: "Shared Assets", group: "operations", host: "config", kicker: "Operations", title: "Shared assets", description: "Global asset keys and image configuration.", maxWidth: "max-w-5xl", island: "spire", glyph: "\u{1F4E6}" },
