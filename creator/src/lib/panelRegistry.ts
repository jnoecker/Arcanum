...
const LORE_PANELS: PanelDef[] = [
  ...
  { id: "loreMaps", label: "Maps", group: "lore", host: "lore", kicker: "Cartography", title: "World maps", description: "Upload maps, place pins, link locations — and use the World Planner tab to generate draft zones from them.", maxWidth: "max-w-7xl", island: "arcanum", glyph: "\u{1F5FA}\uFE0F" },
  ...
  { id: "showcaseSettings", label: "Showcase Site", group: "lore", host: "lore", kicker: "Publication", title: "Showcase site", description: "Branding, banner art, favicon, and colors for the published lore website.", maxWidth: "max-w-5xl", island: "settings", glyph: "\u{1F4F0}" },
