...
const CHARACTER_PANELS: PanelDef[] = [
  ...
  { id: "creation", label: "Creation", host: "config", kicker: "Character foundations", title: "Character creation", description: "Starting state and gender definitions.", maxWidth: "max-w-5xl", island: "orrery", glyph: "\u{1F300}" },
  { id: "equipment", label: "Equipment", host: "config", kicker: "Equipment", title: "Equipment slots", description: "Wear slots and layout.", maxWidth: "max-w-5xl", island: "loom", glyph: "\u{1F6E1}\uFE0F" },
...
const WORLD_PANELS: PanelDef[] = [
  ...
  { id: "world", label: "World", host: "config", kicker: "World topology", title: "World", description: "Default spawn room and per-class start-room overrides.", maxWidth: "max-w-5xl", island: "orrery", glyph: "\u{1F30D}" },
...
const SYSTEMS_PANELS: PanelDef[] = [
  ...
  { id: "crafting", label: "Crafting", host: "config", kicker: "Crafting", title: "Crafting & gathering", description: "Skill leveling, station types, gathering, and recipes.", maxWidth: "max-w-5xl", island: "orrery", glyph: "\u{1F4DC}" },
  { id: "enchanting", label: "Enchanting", host: "config", kicker: "Enchanting", title: "Enchanting system", description: "Enchantment definitions, materials, stat bonuses, and target slots.", maxWidth: "max-w-5xl", island: "orrery", glyph: "\u2728" },
  ...
  { id: "factions", label: "Factions", host: "config", kicker: "Factions", title: "Faction system", description: "Reputation factions, enemy relationships, and quest rewards.", maxWidth: "max-w-5xl", island: "orrery", glyph: "\u{1F3DB}\uFE0F" },
  ...
  { id: "housing", label: "Housing", host: "config", kicker: "Housing", title: "Player housing", description: "Room templates, costs, and housing system settings.", maxWidth: "max-w-5xl", island: "orrery", glyph: "\u{1F3E0}" },
