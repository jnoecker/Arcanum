...
const FULL_MOCK_CONFIG: AppConfig = {
  ...
  observability: { metricsEnabled: false, metricsEndpoint: "", metricsHttpPort: 9100 },
  ...
  dailyQuests: { enabled: true, resetTimeUtc: "06:00", streakBonusPercent: 10, pools: {} },
  globalQuests: { enabled: true, intervalMs: 7200000, durationMs: 3600000, objectives: {}, rewards: {} },
