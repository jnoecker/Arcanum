...
export const ARCHETYPE_CONTRACTS: Record<string, ArchetypeContract> = {
    ...
    combat: [
      {
        ...
        hpRemainingPercent: { min: 30, max: 100 },
      },
      {
        id: "elite-l10",
        label: "Level 10 elite mob",
        inputs: { playerLevel: 10, mobTier: "elite", mobLevel: 10 },
        allowedVerdicts: ["easy", "fair", "risky", "lethal"],
        hpRemainingPercent: { min: 0, max: 100 },
      },
    ],
    economy: {
      id: "economy-l10",
      ...
      goldPerHour: { min: 40000, max: 80000 },
    },
    regen: {
      id: "regen-stat30",
  ...
  balanced: {
    ...
    combat: [
      ...
      },
      {
        ...
        label: "Level 10 elite mob",
        inputs: { playerLevel: 10, mobTier: "elite", mobLevel: 10 },
        allowedVerdicts: ["fair", "risky", "lethal"],
        hpRemainingPercent: { min: 0, max: 85 },
      },
    ],
    economy: {
      id: "economy-l10",
      ...
      goldPerHour: { min: 20000, max: 40000 },
    },
    regen: {
      id: "regen-stat30",
      label: "Regen at stat 30",
  ...
  hardcore: {
    ...
    economy: {
      ...
      goldPerHour: { min: 7000, max: 15000 },
    },
    regen: {
      id: "regen-stat30",
      label: "Regen at stat 30",
