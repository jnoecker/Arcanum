  ...
  return (
    ...
    >
      ...
      {imageSrc ? (
        ...
        <div
          className="flex items-center justify-center rounded bg-bg-tertiary/80"
      ...
      {/* Name label */}
      <p
        className="text-center font-sans text-xs text-white whitespace-nowrap overflow-hidden text-ellipsis pointer-events-none"
